...
Before you ask a question, it is best to search for existing [Issues](https://github.com/aamirazad/dotsy/issues) that might help you. In case you have found a suitable issue and still need clarification, you can write your question in this issue. It is also advisable to search the internet for answers first.
...
- To see if other users have experienced (and potentially already solved) the same issue you are having, check if there is not already a bug report existing for your bug or error in the [bug tracker](https://github.com/aamirazad/dotsy/issues?q=label%3Abug).
...
> You must never report security related issues, vulnerabilities or bugs including sensitive information to the issue tracker, or elsewhere in public. Instead sensitive bugs must be sent by email to <82281117+aamirazad@users.noreply.github.com>. It is recommended to encrypt your email with our [pgp key](https://aamira.me/.well-known/openpgpkey)

We use GitHub issues to track bugs and errors. If you run into an issue with the project:

- Open an [Issue](https://github.com/aamirazad/dotsy/issues/new). (Since we can't be sure at this point whether it is a bug or not, we ask you not to talk about a bug yet and not to label the issue.)
...
This section guides you through submitting an enhancement suggestion for Dotsy, **including completely new features and minor improvements to existing functionality**. Following these guidelines will help maintainers and the community to understand your suggestion and find related suggestions.
...
- Perform a [search](https://github.com/aamirazad/dotsy/issues) to see if the enhancement has already been suggested. If it has, add a comment to the existing issue instead of opening a new one.
...
Enhancement suggestions are tracked as [GitHub issues](https://github.com/aamirazad/dotsy/issues).
...
- **Explain why this enhancement would be useful** to most Dotsy users. You may also want to point out the other projects that solved it better and which could serve as inspiration.
